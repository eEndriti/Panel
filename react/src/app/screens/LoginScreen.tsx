    ...
    <div className="relative flex flex-col items-center justify-center h-screen bg-gray-50">
      ...
      {selectedUser && (
        <div className="flex flex-col items-center w-full max-w-xs">
          ...
          />
          <button
            className="w-full px-6 py-2 bg-indigo-600 text-white font-semibold rounded-lg shadow hover:bg-indigo-700 transition disabled:opacity-50"
            onClick={handleLogin}
      ...
      {/* ===== SECRET BUTTON ===== */}
      {usersLoaded && !dbAvailable && (
        <div className="mb-6 text-center">
          <div className="text-gray-700 font-semibold mb-2">
            Databaza nuk është e konfiguruar
          </div>
          <button
